...
| Events name with file                  | Function
| ------------------------------- | ------------- |
|           :---:                 | :---:         |
...
|ViewRenderEventManager |       |(cross-check)

|Role Controller |      |(cross-check)
