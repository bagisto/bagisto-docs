...
To configure Elasticsearch, please refer to the [Configuration Setup](https://devdocs.bagisto.com/2.0/advanced/indexing-products-to-elasticsearch.html) documentation.
