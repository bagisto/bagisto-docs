...
For a detailed list of changes, please visit the [Bagisto CHANGELOG.md on GitHub](https://github.com/bagisto/bagisto/blob/2.2/CHANGELOG.md).

To ensure a smooth transition to this new version, we have prepared a comprehensive upgrade guide. 
You can find the full upgrade instructions here: [Bagisto UPGRADE.md on GitHub](https://github.com/bagisto/bagisto/blob/2.2/UPGRADE.md).
