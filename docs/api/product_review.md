...
![bagisto_reviews](../assets/images/api/bagisto_reviews.jpg){:class="screenshot-dimension center"}
...
![bagisto_reviews_prod_id](../assets/images/api/bagisto_reviews_prod_id.jpg){:class="screenshot-dimension center"}
