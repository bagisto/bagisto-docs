...
![Create Target Group](../../public/images/configure-load-balancing/create-target-group.png)
...
![Create Load Balancer](../../public/images/configure-load-balancing/load-balancer-port.png)
