...
I hope that you that know how to create a package, if not(refer ( [Package development](create_module.md)), and I will skip package development step.
...
* Check contents of ‘themes.php’ file, it holds all the necessary information about creating a custom theme.

![Bagisto Root Directory](assets/images/Bagisto_Docs_Images/bagisto-theme-2.png){: height="50%" width="100%"}
Contents of themes.php file having the information about currently active theme that is named as default.
...
2. themes: This parameter is where you need to define all credentials for your own custom theme. Multiple themes can also be created and used at the same time in Bagisto.

3. Inside ‘themes’ there is another array by name ‘default‘ which is your currently activated theme. Containing some key-value pairs.
...
Make sure that the name of the blade file should be same as passed in this GET route file like this:
